  ...
  return (
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-6" onClick={onClose}
      ...
      <div className="glass-card w-full max-w-[640px] max-h-[80vh] flex flex-col animate-slide-up"
        ...
        <div className="flex items-center justify-between px-5 py-3 border-b border-[rgba(0,111,207,0.10)]">
          <div className="flex items-center gap-2 min-w-0">
            ...
            {meta.page != null && (
              <span className="text-[10px] px-1.5 py-0.5 rounded shrink-0"
                style={{ background: 'rgba(0,111,207,0.08)', color: 'var(--gold)' }}>p. {meta.page}</span>
            )}
          </div>
          <button onClick={onClose} className="p-1.5 rounded-lg hover:bg-[rgba(0,111,207,0.08)]" style={{ color: 'var(--text-dim)' }}>
